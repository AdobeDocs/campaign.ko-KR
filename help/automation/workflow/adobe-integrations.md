...
description: Adobe Experience Cloud 솔루션 워크플로우와 통합에 대해 자세히 알아보십시오
role: User
...
아래에 설명된 워크플로우는 기본적으로 **Adobe Experience Cloud와 통합** 모듈로 설치됩니다. 이 모듈에 대한 자세한 정보는 [이 페이지](../../v8/connect/integration.md)를 참조하세요.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> <span class="uicontrol">Adobe Experience Cloud로 대상 내보내기</span> <br /> </td> 
