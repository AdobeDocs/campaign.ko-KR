...
워크플로우 만들기 흐름은 워크플로우 유형에 따라 다릅니다. 다음을 수행할 수 있습니다.

* 만들기 [타겟팅 워크플로우](#targeting-workflows) 에서 **[!UICONTROL Profiles and Targets]** > **[!UICONTROL Jobs]** > **[!UICONTROL Targeting workflows]** 탐색기 노드 또는 **[!UICONTROL Profiles and Targets]** 를 통해 홈 페이지의 탭 **[!UICONTROL Targeting workflows]** 하위 탭.

   ![](assets/create-targeting-wf.png)

* 만들기 [캠페인 워크플로우](#campaign-workflows) 에서 **[!UICONTROL Targeting and workflows]** 캠페인의 탭

* 만들기 [기술 워크플로우](#technical-workflows) 에서 **[!UICONTROL Administration]** > **[!UICONTROL Production]** > **[!UICONTROL Technical workflows]** 노드 아래에 있는 노드 아래에 나열된 상태로 남아 있습니다. 우수 사례는 기술 워크플로우를 저장할 특정 워크플로우 폴더를 만드는 것입니다.
...
>[!NOTE]
>
>팔레트가 표시되지 않으면 워크플로우 도구 모음에서 첫 번째 버튼을 클릭하여 표시합니다.

활동은 팔레트의 다른 탭에서 카테고리별로 그룹화됩니다. 사용 가능한 탭과 활동은 워크플로우 유형(기술, 타깃팅 또는 캠페인 워크플로우)에 따라 달라질 수 있습니다.
...
* 네 번째 탭에는 이메일의 수신 또는 서버에 파일이 도착하는 것과 같이, 주어진 이벤트에 따라 달라지는 활동이 포함되어 있습니다. 이러한 활동은에 자세히 설명되어 있습니다 [이벤트 활동](event-activities.md).
...
>[!CAUTION]
>
>동일한 워크플로우 내에서 활동을 복사하고 붙여넣을 수 있습니다. 그러나 다른 워크플로우에서는 붙여넣기 활동을 복사하지 않는 것이 좋습니다. 게재 및 스케줄러와 같은 활동에 첨부된 일부 설정은 대상 워크플로우를 실행하는 동안 충돌과 오류가 발생할 수 있습니다. 대신 다음을 수행하는 것이 좋습니다  **복제** 워크플로우. 자세한 내용은 [워크플로우 복제](#duplicate-workflows).
...
* **도구 모음 사용**
   ...
   * [진행 상태 표시](monitor-workflow-execution.md#displaying-progress)
...
>[!NOTE]
>
>캠페인 워크플로우 활동은 [이 섹션](activities.md).
...
활동을 더 잘 이해하고 워크플로우 정확성을 향상시키기 위해 활동에 주석을 입력할 수 있습니다.

![](assets/example1-comment.png)

연산자가 활동을 스크롤할 때 이러한 주석이 자동으로 표시됩니다.
...
워크플로우 템플릿은 **[!UICONTROL Resources > Templates > Workflow templates]** 노드 아래에 있는 노드 아래에 나열된 상태로 남아 있습니다.

템플릿 속성을 사용하면 일반적인 워크플로우 속성 외에 이 템플릿을 기반으로 만든 워크플로우의 실행 파일을 지정할 수 있습니다.

![](assets/wf-template-properties.png)

## 워크플로우 복제 {#duplicate-workflows}
...
1. 에서 **제한** 탭에서 을 활성화합니다 **이 폴더는 보기입니다** 옵션을 선택하고 **저장**.
