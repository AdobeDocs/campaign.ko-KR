...
1. 드롭다운 목록에서 사용할 중복 제거 방법을 선택하고, 유지할 중복 항목 수를 입력합니다.
   ...
   * **[!UICONTROL Using an expression]**: 지정된 식의 가장 낮은(또는 가장 높은) 값을 가진 레코드를 유지할 수 있습니다.
   ...
   >[!NOTE]
   >
   >**[!UICONTROL Merge]** 링크를 통해 액세스할 수 있는 **[!UICONTROL Advanced parameters]** 기능을 사용하면 필드 또는 필드 그룹을 하나의 결과 데이터 레코드로 병합하기 위해 규칙 집합을 구성할 수 있습니다. 자세한 내용은 [필드를 단일 레코드로 병합](#merging-fields-into-single-record)을 참조하십시오.
