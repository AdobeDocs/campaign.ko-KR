...
아래에 설명된 워크플로는 기본적으로 **소셜 마케팅** 모듈과 함께 설치됩니다. 이 모듈은 X (이전의 Twitter)와의 통합을 활성화합니다.


>[!AVAILABILITY]
>
>facebook을 사용하는 `:warning:` 소셜 마케팅은 Campaign Classic v7에서만 사용할 수 있습니다.
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> <span class="uicontrol">Facebook 통계 계산(v7만 해당)</span> <br /> </td> 
   <td> <span class="uicontrol">statsFacebook</span> <br /> </td> 
   <td> 이 워크플로우는 Facebook 팬과의 상호 작용에 연결된 통계를 계산합니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Facebook 팬 동기화(v7만 해당)</span> <br /> </td> 
   <td> <span class="uicontrol">syncFacebookFans</span> <br /> </td> 
   <td> 이 워크플로우는 매일 오전 7시에 Facebook 팬을 Adobe Campaign으로 가져옵니다.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Facebook 페이지 동기화(v7만 해당)</span> <br /> </td> 
