...
1. **[!UICONTROL SMS routing]**: SMS 복구에 사용할 외부 계정을 선택하십시오. 외부 계정은 트리의 **[!UICONTROL Administration > Platform > External accounts]** 노드를 통해 구성됩니다. [자세히 알아보기](../../v8/config/external-accounts.md)
1. **[!UICONTROL Script]**
