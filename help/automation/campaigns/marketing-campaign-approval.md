...
1. 콘텐츠 책임자에게 알림 이메일이 전송되며 책임자는 승인 여부를 선택할 수 있습니다.
   ...
   * 클라이언트 콘솔 또는 웹 인터페이스, 게재 추적, 게재 대시보드 또는 캠페인 대시보드를 통해 이 캠페인 대시보드를 사용하면 보낸 증명 목록을 클릭하여 볼 수 있습니다. **[!UICONTROL Inbox rendering...]** 링크를 클릭합니다. 콘텐츠를 보려면 **[!UICONTROL Detail]** 목록 오른쪽에 있는 아이콘.
