...
각 캠페인에 대해 게재 대상을 승인할 수 있습니다. [게재 콘텐츠](#approving-content) 비용. 승인을 담당하는 Adobe Campaign 운영자는 이메일로 통보를 받을 수 있으며 클라이언트 콘솔 또는 웹 연결을 통해 승인을 수락하거나 거부할 수 있습니다. [자세히 알아보기](#approving-processes)
...
승인이 필요한 단계는 Campaign 대시보드에 표시됩니다(클라이언트 콘솔 또는 웹 인터페이스를 통해). 게재 추적 테이블 및 게재 대시보드에도 표시됩니다.
...
1. 콘텐츠 책임자에게 알림 이메일이 전송되며 책임자는 승인 여부를 선택할 수 있습니다.
   ...
   * 클라이언트 콘솔 또는 웹 인터페이스, 게재 추적, 게재 대시보드 또는 캠페인 대시보드를 통해 이 캠페인 대시보드를 사용하면 보낸 증명 목록을 클릭하여 볼 수 있습니다. **[!UICONTROL Inbox rendering...]** 링크를 클릭합니다. 콘텐츠를 보려면 **[!UICONTROL Detail]** 목록 오른쪽에 있는 아이콘입니다.
...
1. 그런 다음 클라이언트 콘솔에 로그온하여 게재를 열고 간소화된 마법사를 사용하여 편집하여 제목, HTML 및 텍스트 콘텐츠를 변경하고 증명을 보낼 수 있습니다.
...
1. 콘텐츠 편집 담당자는 게재 콘텐츠를 변경하고 나면 콘텐츠를 사용 가능하게 만들 수 있습니다.
   ...
   * 다음 **[!UICONTROL Available content]** Adobe Campaign 클라이언트 콘솔의 링크입니다.
   * 알림 메시지의 링크.
...
이러한 링크는 하나 이상의 증명을 보낸 경우에만 사용할 수 있습니다. 그렇지 않으면 클라이언트 콘솔 또는 웹 인터페이스를 통해서만 게재 렌더링을 사용할 수 있습니다.
...
클라이언트 콘솔 또는 웹 인터페이스를 통해 작업을 승인하려면 캠페인 대시보드에서 해당 링크를 클릭합니다.
