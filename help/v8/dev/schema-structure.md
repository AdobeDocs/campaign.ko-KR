...
자세한 목록은 [Campaign Classic v7 설명서](https://experienceleague.adobe.com/docs/campaign-classic/using/configuring-campaign-classic/schema-reference/elements-attributes/schema-introduction.html?lang=en#configuring-campaign-classic)에서 확인할 수 있습니다.
...
* **uuid**: &quot;uniquidentifier&quot; 필드
   ...
   >[!NOTE]
   >
   >**uuid** 필드를 포함하려면 &quot;newuuid()&quot; 함수를 추가하고 해당 기본값으로 완료해야 합니다.
