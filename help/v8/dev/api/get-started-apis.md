...
>[!AVAILABILITY]
>
>* 이 기능은 모든 [Campaign FDA 환경](../../architecture/fda-deployment.md)에 대해 요청 시에만 사용할 수 있습니다. [엔터프라이즈(FFDA) 배포](../../architecture/enterprise-deployment.md)에 사용할 수 있는 **없음**&#x200B;입니다. 액세스 권한을 받으려면 Adobe 담당자에게 문의하십시오.
>
