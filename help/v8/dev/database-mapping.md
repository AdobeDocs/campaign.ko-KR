...
Adobe Campaign 테이블의 기본 키는 데이터베이스 엔진에서 자동으로 생성된 **UUID(Universal Unique ID)**&#x200B;입니다. 키 값은 전체 데이터베이스에서 고유합니다. 키의 내용은 레코드를 삽입할 때 자동으로 생성됩니다.
...
키 정의 외에도 자동 생성된 기본 키를 포함하기 위해 &quot;id&quot;라는 숫자 필드가 확장 스키마에 추가되었습니다.
...
## 링크:{#links--relation-between-tables} 표 사이의 관계
...
* ![](assets/do-not-localize/join_with_campaign11.png) :카디널리티 1-1. 예를 들어 받는 사람과 현재 순서 간. 수신자는 현재 주문 테이블의 한 번에 한 번만 관련될 수 있습니다.
* ![](assets/do-not-localize/externaljoin11.png) :카디널리티 1-1, 외부 연결. 예를 들어, 수신자와 해당 국가 간의 경우입니다. 받는 사람은 테이블 국가의 한 번만 관련될 수 있습니다. 국가 테이블의 내용은 저장되지 않습니다.
* ![](assets/do-not-localize/join_with_campaign1n.png) :기수 1-N.예를 들어 수신자와 가입 테이블 간의 경우입니다. 수신자는 가입 테이블의 여러 작업과 관련될 수 있습니다.
...
: 전구:FDA 표에 대한 자세한 내용은 [Federated Data Access](../connect/fda.md)를 참조하십시오.
