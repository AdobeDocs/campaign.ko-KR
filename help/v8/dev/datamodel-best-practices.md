...
하이브리드 인스턴스와 온-프레미스 인스턴스의 경우 FDA(외부 데이터에 액세스할 수 있는 옵션 기능인 Federated Data Access)는 캠페인 프로세스 중에 필드를 &quot;즉시&quot; 추가해야 하는 필요성을 다룹니다. FDA를 가지고 있다면 모든 것을 가져올 필요가 없습니다. 자세한 내용은 [통합 데이터 액세스](../connect/fda.md)를 참조하십시오.
...
Adobe Campaign 기본 키는 모든 기본 제공 테이블에 대해 자동으로 생성된 UUID로, 사용자 지정 테이블에 대해 같을 수 있습니다.
