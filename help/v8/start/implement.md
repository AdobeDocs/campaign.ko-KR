...
title: 구현 지침
description: Campaign v8을 구현하는 방법 알아보기
feature: 개요
role: Data Engineer
level: Beginner
...
이 섹션에서는 회사의 요구 사항에 맞게 Adobe Campaign을 조정하는 방법을 알아봅니다. 다음 지침을 사용하여 구현을 구조화하고 구성합니다.

1. **설정 정의**:액세스 권한 부여, 클라이언트 콘솔 공유, 채널 구성(이메일, 푸시, sms)
1. **환경 준비**:프로필 가져오기, 대상자 만들기, 디자인 워크플로우 및 캠페인 템플릿, 유형화 규칙 만들기
1. **인스턴스 사용자 지정**:새 데이터 필드 만들기, 테이블/스키마 추가
1. **배포 확장**:Adobe 솔루션, 기타 제품 및 시스템 - 커넥터, 멀티 솔루션 설정에 연결
...
이 섹션에는 실제 구현을 시작하기 전에 검토 및 고려해야 하는 개인 정보 및 보안에 대한 중요한 정보가 포함되어 있습니다.
...
다양한 Campaign 영역 및 기능을 사용자 지정할 수 있습니다. 대부분의 고객은 다음 세 가지 항목을 사용자 정의합니다.
...
1. **보고서**
   ...
   Campaign은 게재 모니터링, URL 및 클릭 스트림, 추적, 게재 기능 지표 등에 대한 기본 제공 보고서 세트를 제공합니다.
...
복잡한 마케팅 캠페인을 여러 채널의 다양한 대상에 오케스트레이션하려면 Campaign 자동화 기능을 활용하십시오.
...
다른 Adobe 솔루션을 사용하는 경우 Campaign 환경에 연결하고 기능을 결합할 수 있습니다.
...
* 캠페인 - Target
* Campaign - Audience Manager / People 핵심 서비스
* 캠페인 - 자산
