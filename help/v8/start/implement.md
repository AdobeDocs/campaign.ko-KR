...
![](../assets/do-not-localize/glass.png) [Campaign 클라이언트 콘솔에 대해 자세히 알아보기](connect.md).
...
SSO(Single Sign-On)만 사용하여 Campaign에 연결할 수 있습니다. [이 페이지](connect.md)에서 자세히 알아보십시오.
