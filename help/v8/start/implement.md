...
에서 Adobe Campaign에 사용자를 추가하는 방법 알아보기 [이 섹션](../start/gs-permissions.md).
...
1. **Campaign의 내장 데이터 모델 익히기**
   ...
   [Campaign 데이터 모델에 대해 자세히 알아보기](../dev/datamodel.md).
...
1. **테이블 및 스키마**
   ...
   자세한 내용은 이 섹션 을 참조하십시오. [Campaign 기본 제공 데이터 모델](../dev/datamodel.md).
...
1. **대시보드 및 목록**
   ...
   Campaign에서 필터 및 목록을 관리하는 방법 알아보기 [이 페이지](../dev/customize.md#gs-lists-and-filters).
...
1. **보고서**
   ...
   Campaign의 보고 기능에 대해 자세히 알아보기 [이 페이지](../reporting/gs-reporting.md).
...
Adobe Campaign과 통합할 수 있는 Adobe 솔루션의 전체 목록 살펴보기 [이 페이지에서](../connect/integration.md).

### 커넥터{#implementation-connectors}

Adobe Campaign을 타사 시스템과 연계하여 다양한 기능을 통합하고 프로세스를 자동화할 수 있습니다.

에서 사용 가능한 커넥터에 대해 자세히 알아봅니다. [이 섹션](../connect/integration.md).

**CRM을 Campaign에 연결하기**

Adobe Campaign 플랫폼을 타사 CRM 시스템에 연결하여 연락처, 계정, 구매 등의 데이터를 동기화할 수 있습니다.

CRM 시스템을 Campaign에 연결하는 방법 알아보기 [이 섹션](../connect/integration.md#gs-crm-connectors)
