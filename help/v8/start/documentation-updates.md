...
업데이트된 일정에 따라 실행되도록 **[!UICONTROL Scheduler]** 활동의 예약된 시간을 변경한 후 워크플로를 다시 시작하는 모범 사례를 추가했습니다. [자세히 보기](../../automation/workflow/scheduler.md)

## 2025년 1월 {#january-2025}

FFDA 배포를 위한 데이터 복제 관련 페이지가 재구성되었으며 새 정보로 보강되었습니다. [자세히 보기](../architecture/replication.md)

## 2024년 11월 {#october-2024}

* **ffdaUnsuscribe** 워크플로가 기술 워크플로 목록에 추가되었습니다. [자세히 보기](../../automation/workflow/technical-workflows.md)
* Campaign 버전 및 업그레이드에 대한 페이지가 개선되었습니다. [자세히 보기](upgrades.md)
...
* [!DNL Campaign] v8.6 릴리스에 포함된 모든 새로운 기능, 변경 사항 및 개선 사항은 설명서에 자세히 설명되어 있습니다. [자세히 보기](release-notes.md)
