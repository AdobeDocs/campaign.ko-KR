---
title: Campaign v8 2022 릴리스 노트
description: 2022년 Campaign v8 릴리스와 함께 제공되는 기능 및 개선 사항 목록
feature: Overview
...
이 페이지에는 다음과 같은 새로운 기능, 개선 사항 및 수정 사항이 나와 있습니다 **2022년 Campaign v8 릴리스**.
