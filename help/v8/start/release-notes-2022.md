...
* 이제 지정된 개인정보 보호 네임스페이스에 대해 개인정보 보호 요청이 배치 방식으로 수행됩니다. 이러한 개선 사항으로 GDPR/개인 정보 보호 삭제 요청에 대한 실행 시간이 늘어납니다.
...
<tbody> 
<tr> 
<td> <p>Campaign Distributed Marketing을 사용하면 중앙 엔터티(본사, 마케팅 부서 등)와 및 로컬 엔티티(판매 지점, 지역 에이전시 등). 공유 작업 공간(캠페인 패키지)을 통해 캠페인 템플릿을 만들고 로컬 엔티티에 제안할 수 있습니다.</p>
