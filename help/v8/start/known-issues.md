...
이 페이지[에서 Adobe 소프트웨어 배포 &#x200B;](https://experienceleague.adobe.com/docs/experience-cloud/software-distribution/home.html?lang=ko){target="_blank"}에 액세스하는 방법을 알아보세요.
