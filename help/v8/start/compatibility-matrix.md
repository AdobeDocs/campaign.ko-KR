...
Campaign으로 [푸시 알림](../send/push.md)을 보내려면 데이터 수집 UI에서 Adobe Campaign을 구성하여 Adobe Experience Platform Mobile SDK를 사용할 수 있습니다. 아래 목록의 Campaign SDK를 사용할 수도 있습니다.
