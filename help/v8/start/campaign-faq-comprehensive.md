...
[랜딩 페이지 만들기(웹 UI)](https://experienceleague.adobe.com/en/docs/campaign-web/v8/landing-pages/get-started-lp){target="_blank"} | [웹 응용 프로그램(클라이언트 콘솔)](../dev/landing-pages.md)
