...
[사용 권한 시작](gs-permissions.md) | [사용자 사용 권한 관리](manage-permissions.md) | [폴더에 사용 권한 추가](folder-permissions.md)
...
[Campaign v7에서 v8로 마이그레이션](../start/v7-to-v8.md#limitations) | [FFDA 아키텍처](../architecture/enterprise-deployment.md)
...
[릴리스 노트](release-notes.md) | [새로운 기능](whats-new.md) | [Campaign 버전 및 업그레이드](upgrades.md)
...
* 보안 그룹 → **연산자 그룹** | 조직 단위 → **폴더 권한**

**Campaign 웹 UI 업데이트:**

* 수신자 → **프로필** | 시드 주소 → **테스트 프로필** | 게재 분석 → **게재 준비**
* **→** 목록 | 전자 메일 미리 보기 → **콘텐츠 시뮬레이션**
...
[기능 매트릭스](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/start/capability-matrix){target="_blank"} | [v7에서 v8로의 전환 안내서](v7-to-v8.md) | [Campaign Standard에서 v8로의 전환](https://experienceleague.adobe.com/ko/docs/campaign-web/v8/start/acs-migration){target="_blank"}
...
[게재 분석](../send/delivery-analysis.md) | [게재 전송 및 추적](../send/send.md)
...
[기본 제공 게재 보고서](../reporting/delivery-reports.md) | [Campaign 보고](../reporting/gs-reporting.md)
...
[권한 시작](gs-permissions.md) | [보안 지침](../config/security.md) | [향상된 보안 추가 기능](../config/enhanced-security.md)
