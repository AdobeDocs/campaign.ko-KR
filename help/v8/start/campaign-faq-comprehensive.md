...
연결, 시작 및 지원 액세스 방법을 포함하여 Adobe Campaign v8에 대해 가장 일반적인 질문에 대한 답변을 얻을 수 있습니다.
...
**일반 리소스:** [Campaign v8 기능 매트릭스](https://experienceleague.adobe.com/en/docs/campaign-web/v8/start/capability-matrix){target="_blank"} | [호환성 매트릭스](compatibility-matrix.md)
