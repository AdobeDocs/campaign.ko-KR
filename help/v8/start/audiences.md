...
* [데이터 파일 가져오기](import.md) CRM 시스템과 같은 외부 데이터 소스
...
![](../assets/do-not-localize/book.png) 에서 프로필을 관리하는 방법을 알아봅니다 [Adobe Campaign Classic v7 설명서](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/profile-management/about-profiles.html){target=&quot;_blank&quot;}.
...
![](../assets/do-not-localize/book.png) 에서 개인 정보 및 동의를 관리하는 방법을 알아봅니다 [Adobe Campaign Classic v7 설명서](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/privacy/privacy-and-recommendations.html){target=&quot;_blank&quot;}.

## 목록 만들기

목록은 게재 작업에서 타겟팅되거나 가져오기 작업 또는 워크플로우 실행 중에 업데이트될 수 있는 정적 프로필 세트입니다. 예를 들어 쿼리를 통해 데이터베이스에서 추출한 모집단은 목록을 제공할 수 있습니다.

![](../assets/do-not-localize/book.png) 에서 목록을 만들고 관리하는 방법을 알아봅니다. [Adobe Campaign Classic v7 설명서](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/profile-management/creating-and-managing-lists.html){target=&quot;_blank&quot;}.

## 데이터베이스를 쿼리합니다.

를 사용하십시오 **쿼리** 워크플로우에서 활동을 통해 데이터베이스를 쿼리하고 세그먼트 데이터를 수집하여 복잡한 대상을 만들 수 있습니다.

![](../assets/do-not-localize/book.png) 에서 Campaign 쿼리에 대해 자세히 알아보십시오 [Adobe Campaign Classic v7 설명서](https://experienceleague.adobe.com/docs/campaign-classic/using/automating-with-workflows/introduction/targeting-data.html){target=&quot;_blank&quot;}.

![](../assets/do-not-localize/book.png) 모든 타겟팅 활동은 다음과 같이 나열됩니다. [Adobe Campaign Classic v7 설명서](https://experienceleague.adobe.com/docs/campaign-classic/using/automating-with-workflows/targeting-activities/about-targeting-activities.html){target=&quot;_blank&quot;}.
