...
* **프로그램**: 프로그램을 사용하여 일정 기간(시작, 캔버스, 충성도 등)에 대한 마케팅 작업을 정의할 수 있습니다. 각 프로그램에는 전체 보기를 제공하는 달력에 연결된 캠페인이 포함되어 있습니다.
...
Adobe Campaign에서는 중앙 엔터티(본사, 마케팅 부서 등) 간의 공동 캠페인을 구현하기 위한 **분산 마케팅** 추가 기능을 제공합니다. 지역(상점, 지역 등) 이러한 협력은 공유 작업 공간(**[!UICONTROL List of campaign packages]**)을 기반으로 하는데, 중앙 엔티티에 의해 설계된 캠페인 템플릿이 로컬 엔티티에 제공됩니다.
