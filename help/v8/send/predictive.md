...
* 일주일 중 7일 동안 1시간 간격(예: 오전 9:00, 오전 10:00, 오전 11:00)으로 이메일을 전송하기 위해 하루 중 가장 적합한 시간을 계산
...
* **보존의 백분위 등급**:구독 취소 가능성에 대한 프로필 순위. 값의 범위는 0.0부터 1.0까지입니다. 예를 들어, 유지 비율 등급이 0.953이면 이 수신자는 브랜드를 계속 사용할 가능성이 높고 전체 수신자의 95.3%보다 구독을 취소할 가능성이 낮습니다.
