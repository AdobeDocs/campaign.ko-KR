...
Adobe Campaign은 고성능 이메일 게재 엔진인 **Enhanced MTA**(메일 전송 에이전트)을(를) 사용합니다.

Enhanced MTA에는 보다 스마트한 바운스 처리 및 발신자가 최적의 받은 편지함 게재 비율을 달성하고 유지하는 데 도움이 되는 자동 게재 기능 최적화 기능이 포함되어 있습니다.
