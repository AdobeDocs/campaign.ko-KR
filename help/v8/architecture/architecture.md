...
>[!AVAILABILITY]
>
>이 기능은 여러 MID(중간 소싱) 인스턴스 구성이 있는 고객만 사용할 수 있습니다.
...
>
>기본적으로 여러 MID(중간 소싱) 인스턴스 간에 게재를 분할하는 임계값 크기 값은 10K입니다. **[!UICONTROL Administration]** / **[!UICONTROL Platform]** / **[!UICONTROL Options]** 메뉴의 &quot;NmsDelivery_MultiMidSplitThreshold&quot; 옵션에서 이 값을 변경할 수 있습니다.
...
그런 다음 위의 호출에 대한 응답으로 실행 인스턴스가 제공하는 sessionToken을 사용하여 외부 애플리케이션이 계정 로그인 및 암호를 각 SOAP 호출에 포함할 필요 없이 커뮤니케이션을 전송하기 위해 SOAP api 호출(rtEvents 또는 batchEvents)을 수행할 수 있습니다.
